...
`im-ELY2dohC6fxZVS7MuAnm3x` and publishes `astra-blender:v7`. The base contains
...
Version 7 adds plugin 0.3.2 with construction, source verification, and lived-in styling guidance. Version 6 includes the viewer-camera export skill and its camera/delivery helpers.
...
image.publish("astra-blender:v7")
```
