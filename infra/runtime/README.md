...
`im-ELY2dohC6fxZVS7MuAnm3x` and publishes `astra-blender:v8`. The base contains
...
Version 8 adds plugin 0.3.3 with fixture-connection, enclosure-gap, and final visual-acceptance checks. Version 7 adds plugin 0.3.2 with construction, source verification, and lived-in styling guidance. Version 6 includes the viewer-camera export skill and its camera/delivery helpers.
...
image.publish("astra-blender:v8")
```
