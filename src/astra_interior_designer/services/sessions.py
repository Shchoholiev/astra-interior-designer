    ...
    def __init__(
        ...
        *,
        ...
        instructions: str = (
            ...
            "apply the installed interior-design, build-interior-scene, find-3d-models, "
            "cycles-materials, "
            "light-and-render-interior, review-interior-render, and "
            "export-viewer-render skills and their relevant references. "
            "Before detailing prominent furniture, plants, and decor, search for "
            "suitable existing 3D assets using find-3d-models. Import suitable "
            "accessible matches and verify them in the scene; record source and "
            "imported objects, or the specific reason for a modeled fallback. "
            "An unavailable furniture asset does not end the search for decor. "
            "Texture and HDRI downloads do not count as sourcing 3D objects. "
            "Refine the layout's placeholder geometry, materials, visible surface detail, "
