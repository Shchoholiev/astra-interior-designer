...
The default `astra-blender:v10` image layers the existing S3/executor runtime onto
...
`environment.capability_directories`, exposing its seven skills and references to
