...
Use when these objects look inflated, plush, rubbery, or toy-like. Start by identifying the intended construction from the brief or reference. A filled cushion, a woven floor covering, and a painting need different volume and edge treatments. Keep the accepted palette, composition, and placement while correcting the demonstrated excess softness.

## Choose the construction before adding surface detail

| Object | Construction to represent | Check in the rendered image |
| --- | --- | --- |
| Loose pillow or cushion | A sewn cover containing filling: broad panels, a narrower seam perimeter, and fullness shaped by filling and support. Distinguish a loose pillow from a firm boxed seat cushion with a gusset. | Side thickness, center fullness, corner taper and contact compression should describe that construction. A uniformly beveled box with an inset seam still reads as foam. |
| Woven or low-pile rug | A thin backing and textile surface, with pile height and binding appropriate to the chosen rug. Build the border into the weave or binding rather than a second padded strip. | Inspect the near edge and furniture contact: it should read as a floor textile, not a mattress or upholstered platform. Fibers affect the surface more than the entire outline. |
| Painting or framed print | A rigid frame, a stretched canvas or flat paper support, and a painted or printed image. Separate the frame depth from the image surface. | The motif should lie on the support; colored shapes should not bulge or cast separate object shadows merely because they were made from beveled meshes. Inspect both the face and a grazing view. |
